...
SetAnimationSpeed.prototype._init = function() {
  ...
  this.container = domify(
    '<div align="left" class="set-animation-speed hidden">' +
      '<div class="animation-speed-buttons">' +
        '<div title="Lento" id="animation-speed-1" class="animation-speed-button"><i class="fa fa-angle-right" aria-hidden="true"></i></div>' +
        ...
        '<div title="Rápido" id="animation-speed-3" class="animation-speed-button"><i class="fa fa-angle-right" aria-hidden="true"></i><i class="fa fa-angle-right" aria-hidden="true"></i><i class="fa fa-angle-right" aria-hidden="true"></i></div>' +
      '</div>' +
    '</div>'
  );
