...
ToggleMode.prototype._init = function() {
  this.container = domify(`
    <div class="toggle-mode">
      Iniciar Simulação <span class="toggle"><i class="fa fa-toggle-off"></i></span>
    </div>
  `);
...
ToggleMode.prototype.toggleMode = function() {
  if (this.simulationModeActive) {
    this.container.innerHTML = 'Iniciar Simulação <span class="toggle"><i class="fa fa-toggle-off z-depth-5"></i></span>';
    ...
    this.container.innerHTML = 'Iniciar Simulação <span class="toggle"><i class="fa fa-toggle-on z-depth-5"></i></span>';
