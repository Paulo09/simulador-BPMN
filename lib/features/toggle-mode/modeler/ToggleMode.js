...
ToggleMode.prototype.toggleMode = function() {
  if (this.simulationModeActive) {
    this.container.innerHTML = 'Iniciar Simulação <span class="toggle"><i class="fa fa-toggle-off"></i></span>';
    ...
    this.container.innerHTML = 'Iniciar Simulação <span class="toggle"><i class="fa fa-toggle-on"></i></span>';
